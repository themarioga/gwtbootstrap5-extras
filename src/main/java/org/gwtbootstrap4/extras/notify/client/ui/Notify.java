 ...
 * {@see org.gwtbootstrap4.extras.notify.client.ui.NotifySettings}
 * <p/>
...
public class Notify extends JavaScriptObject {
     ...
     * @return Displayed Notify for update or hiding.
     * @see org.gwtbootstrap4.extras.notify.client.constants.NotifyType
     */
    public static final native Notify notify(final String message, final NotifyType type) /*-{
        return $wnd.jQuery.notify({ message: message }, { type: type.@org.gwtbootstrap4.extras.notify.client.constants.NotifyType::getCssName()() });
    }-*/;
    ...
    public static final native Notify notify(final String title, final String message, final NotifyType type) /*-{
        return $wnd.jQuery.notify({ title: title, message: message }, { type: type.@org.gwtbootstrap4.extras.notify.client.constants.NotifyType::getCssName()() });
    }-*/;
    ...
    public static final native Notify notify(final String title, final String message, final String icon, final NotifyType type) /*-{
        return $wnd.jQuery.notify({ title: title, message: message, icon: icon }, { type: type.@org.gwtbootstrap4.extras.notify.client.constants.NotifyType::getCssName()() });
    }-*/;
    ...
    public static final native Notify notify(final String title, final String message, final String icon, final String url, final NotifyType type) /*-{
        return $wnd.jQuery.notify({ title: title, message: message, icon: icon, url: url }, { type: type.@org.gwtbootstrap4.extras.notify.client.constants.NotifyType::getCssName()() });
    }-*/;
     ...
     * @see org.gwtbootstrap4.extras.notify.client.constants.NotifyPlacement
     */
    public static final native void hideAll(NotifyPlacement placement) /*-{
        if (plamenet !== null) {
            $wnd.jQuery.notifyClose(placement.@org.gwtbootstrap4.extras.notify.client.constants.NotifyPlacement::getPlacement()());
        }
    }-*/;
