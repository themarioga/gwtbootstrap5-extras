package org.gwtbootstrap4.extras.notify.client.ui;
...
import org.gwtbootstrap4.extras.animate.client.ui.constants.Animation;
import org.gwtbootstrap4.extras.notify.client.constants.NotifyIconType;
import org.gwtbootstrap4.extras.notify.client.constants.NotifyPlacement;
import org.gwtbootstrap4.extras.notify.client.constants.NotifyPosition;
import org.gwtbootstrap4.extras.notify.client.constants.NotifyType;
import org.gwtbootstrap4.extras.notify.client.constants.NotifyUrlTarget;
import org.gwtbootstrap4.extras.notify.client.event.NotifyCloseHandler;
import org.gwtbootstrap4.extras.notify.client.event.NotifyClosedHandler;
import org.gwtbootstrap4.extras.notify.client.event.NotifyShowHandler;
import org.gwtbootstrap4.extras.notify.client.event.NotifyShownHandler;
...
public class NotifySettings extends JavaScriptObject {
    ...
    private final native void setNotifyPlacement(final NotifyPlacement placement) /*-{
        var from = placement.@org.gwtbootstrap4.extras.notify.client.constants.NotifyPlacement::getFrom()();
        var align = placement.@org.gwtbootstrap4.extras.notify.client.constants.NotifyPlacement::getAlign()();
     ...
     *
     * @see org.gwtbootstrap4.extras.animate.client.ui.constants.Animation
     *
    ...
    private final native void onShow(NotifyShowHandler handler) /*-{
        this.onShow = function() {
            handler.@org.gwtbootstrap4.extras.notify.client.event.NotifyShowHandler::onShow()();
        };
    }-*/;
    ...
    private final native void onShown(NotifyShownHandler handler) /*-{
        this.onShow = function() {
            handler.@org.gwtbootstrap4.extras.notify.client.event.NotifyShownHandler::onShown()();
        };
    }-*/;
    ...
    private final native void onClose(NotifyCloseHandler handler) /*-{
        this.onClose = function() {
            handler.@org.gwtbootstrap4.extras.notify.client.event.NotifyCloseHandler::onClose()();
        };
    }-*/;
    ...
    private final native void onClosed(NotifyClosedHandler handler) /*-{
        this.onClosed = function() {
            handler.@org.gwtbootstrap4.extras.notify.client.event.NotifyClosedHandler::onClosed()();
        };
    }-*/;
