package org.gwtbootstrap4.extras.gallery.client.ui;
...
import org.gwtbootstrap4.client.ui.Heading;
...
import org.gwtbootstrap4.extras.gallery.client.events.GalleryCloseEvent;
import org.gwtbootstrap4.extras.gallery.client.events.GalleryCloseHandler;
import org.gwtbootstrap4.extras.gallery.client.events.GalleryClosedEvent;
import org.gwtbootstrap4.extras.gallery.client.events.GalleryClosedHandler;
import org.gwtbootstrap4.extras.gallery.client.events.GalleryOpenEvent;
import org.gwtbootstrap4.extras.gallery.client.events.GalleryOpenHandler;
import org.gwtbootstrap4.extras.gallery.client.events.GalleryOpenedEvent;
import org.gwtbootstrap4.extras.gallery.client.events.GalleryOpenedHandler;
import org.gwtbootstrap4.extras.gallery.client.events.GallerySlideCompleteEvent;
import org.gwtbootstrap4.extras.gallery.client.events.GallerySlideCompleteHandler;
import org.gwtbootstrap4.extras.gallery.client.events.GallerySlideEndEvent;
import org.gwtbootstrap4.extras.gallery.client.events.GallerySlideEndHandler;
import org.gwtbootstrap4.extras.gallery.client.events.GallerySlideEvent;
import org.gwtbootstrap4.extras.gallery.client.events.GallerySlideHandler;
    ...
    private native void configure(Element e) /*-{
        ...
        $wnd.jQuery(e)
            .on('open', function (e) {
                ...
                that.@org.gwtbootstrap4.extras.gallery.client.ui.Gallery::onOpen(Lcom/google/gwt/user/client/Event;)(e);
            })
            .on('opened', function (e) {
                // Callback function executed when the Gallery has been initialized
                // and the initialization transition has been completed.
                that.@org.gwtbootstrap4.extras.gallery.client.ui.Gallery::onOpened(Lcom/google/gwt/user/client/Event;)(e);
            })
            .on('close', function (e) {
                // Callback function executed when the Gallery is about to be closed.
                that.@org.gwtbootstrap4.extras.gallery.client.ui.Gallery::onClose(Lcom/google/gwt/user/client/Event;)(e);
            })
            .on('closed', function (e) {
                // Callback function executed when the Gallery has been closed
                // and the closing transition has been completed.
                that.@org.gwtbootstrap4.extras.gallery.client.ui.Gallery::onClosed(Lcom/google/gwt/user/client/Event;)(e);
            })
            .on('slide', function (e, index, slide) {
                // Callback function executed on slide change.
                that.@org.gwtbootstrap4.extras.gallery.client.ui.Gallery::onSlide(*)(e, index);
            })
            .on('slideend', function (e, index, slide) {
                // Callback function executed after the slide change transition.
                that.@org.gwtbootstrap4.extras.gallery.client.ui.Gallery::onSlideEnd(*)(e, index);
            })
            .on('slidecomplete', function (e, index, slide) {
                // Callback function executed on slide content load.
                that.@org.gwtbootstrap4.extras.gallery.client.ui.Gallery::onSlideComplete(*)(e, index);
            });
    }-*/;
