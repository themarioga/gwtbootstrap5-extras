...
public class ColumnFormat extends AbstractViewOptionFormat implements IsJavaScriptObject {
    ...
    private native void newInstance() /*-{
        ...
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.ColumnFormat::format = {};
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.ColumnFormat::format.columnFormat = {};
    }-*/;

    private native void setFormat(String format, String viewOption) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.TimeFormat::format.columnFormat[viewOption] = format;
    }-*/;
