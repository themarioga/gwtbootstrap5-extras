...
public class DayNames implements IsJavaScriptObject {
    ...
    private native void newInstance() /*-{
        ...
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.DayNames::names = {};
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.DayNames::names.dayNames = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.DayNames::names.dayNamesShort = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
    }-*/;
    ...
    public native void localized(JsArrayString longNames, JsArrayString shortNames) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.DayNames::names.dayNames = longNames;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.DayNames::names.dayNamesShort = shortNames;
    }-*/;
