...
public class AgendaOptions implements IsJavaScriptObject {
    ...
    public native void newInstance() /*-{
        ...
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options = {
            allDaySlot: true,
            allDayText: "all-day",
            axisFormat: "h(:mm)a",
    ...
    public native void setAllDaySlot(boolean allDay) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.allDaySlot = allDay;
    }-*/;
    ...
    public native void setAllDayText(String text) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.allDayText = text;
    }-*/;
    ...
    public native void setAxisFormat(String format) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.axisFormat = format;
    }-*/;
    ...
    public native void setSlotDuration(String timeString) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.slotDuration = timeString;
    }-*/;
    ...
    public native void setSnapDuration(String timeString) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.snapDuration = timeString;
    }-*/;
    ...
    public native void setScrollTime(String timeString) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.scrollTime = timeString;
    }-*/;
    ...
    public native void setMinTime(String timeString) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.minTime = timeString;
    }-*/;
    ...
    public native void setMaxTime(String timeString) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.maxTime = timeString;
    }-*/;
    ...
    public native void setSlotEventOverlap(boolean overlap) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.AgendaOptions::options.slotEventOverlap = overlap;
    }-*/;
