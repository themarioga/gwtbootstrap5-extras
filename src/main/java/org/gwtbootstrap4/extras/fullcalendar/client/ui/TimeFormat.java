...
public class TimeFormat extends AbstractViewOptionFormat implements IsJavaScriptObject {
    ...
    private native void newInstance(String defaultValue) /*-{
        ...
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.TimeFormat::format = {};
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.TimeFormat::format.timeFormat = {
            // for all other views
            '': defaultValue
        };
    ...
    private native void setFormat(String format, String viewOption) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.TimeFormat::format.timeFormat[viewOption] = format;
    }-*/;
