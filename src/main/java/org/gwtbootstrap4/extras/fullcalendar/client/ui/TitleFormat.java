...
public class TitleFormat extends AbstractViewOptionFormat implements IsJavaScriptObject {
    ...
    private native void newInstance() /*-{
        ...
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.TitleFormat::format = {};
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.TitleFormat::format.titleFormat = {};
    }-*/;

    private native void setFormat(String format, String viewOption) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.TitleFormat::format.titleFormat[viewOption] = format;
    }-*/;
