...
public class MonthNames implements IsJavaScriptObject {
    ...
    private native void newInstance() /*-{
        ...
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.MonthNames::names = {};
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.MonthNames::names.monthNames = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.MonthNames::names.monthNamesShort = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
    }-*/;
    ...
    public native void localize(JsArrayString longNames, JsArrayString shortNames) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.MonthNames::names.monthNames = longNames;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.MonthNames::names.monthNamesShort = shortNames;
    }-*/;
