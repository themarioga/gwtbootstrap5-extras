...
public class Header {
    ...
    private native void newInstance() /*-{
        ...
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.Header::header = {left: 'title', center: '', right: 'today prev,next'};
    }-*/;

    public native void setNoHeader() /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.Header::header = null;
    }-*/;

    public native void setLeft(String left) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.Header::header.left = left;
    }-*/;

    public native void setCenter(String center) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.Header::header.center = center;
    }-*/;

    public native void setRight(String right) /*-{
        var theInstance = this;
        theInstance.@org.gwtbootstrap4.extras.fullcalendar.client.ui.Header::header.right = right;
    }-*/;
