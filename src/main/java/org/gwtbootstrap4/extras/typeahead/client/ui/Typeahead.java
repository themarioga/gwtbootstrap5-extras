package org.gwtbootstrap4.extras.typeahead.client.ui;
...
import org.gwtbootstrap4.extras.typeahead.client.base.CollectionDataset;
import org.gwtbootstrap4.extras.typeahead.client.base.Dataset;
import org.gwtbootstrap4.extras.typeahead.client.base.Suggestion;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadAutoCompletedEvent;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadAutoCompletedHandler;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadClosedEvent;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadClosedHandler;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadCursorChangedEvent;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadCursorChangedHandler;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadOpenedEvent;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadOpenedHandler;
...
public class Typeahead<T> extends TextBox {
    ...
    private native JavaScriptObject toJSO(Dataset<T> dataset) /*-{
        var emptyTemplate = dataset.@org.gwtbootstrap4.extras.typeahead.client.base.Dataset::getEmptyTemplate()();
        var headerTemplate = dataset.@org.gwtbootstrap4.extras.typeahead.client.base.Dataset::getHeaderTemplate()();
        var footerTemplate = dataset.@org.gwtbootstrap4.extras.typeahead.client.base.Dataset::getFooterTemplate()();
        var suggestionTemplate = dataset.@org.gwtbootstrap4.extras.typeahead.client.base.Dataset::getSuggestionTemplate()();

        var findMatches = function () {
            return function (query, cb) {
                var scb = @org.gwtbootstrap4.extras.typeahead.client.base.SuggestionCallback::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cb);
                return dataset.@org.gwtbootstrap4.extras.typeahead.client.base.Dataset::findMatches(Ljava/lang/String;Lorg/gwtbootstrap4/extras/typeahead/client/base/SuggestionCallback;)(query, scb);
            };
        };

        return {
            name: dataset.@org.gwtbootstrap4.extras.typeahead.client.base.Dataset::name,
            source: findMatches(),
            templates: {
                empty: (emptyTemplate != null ? function (query) {
                    return emptyTemplate.@org.gwtbootstrap4.extras.typeahead.client.base.Template::render()();
                } : undefined),
                header: (headerTemplate != null ? function (query) {
                    return headerTemplate.@org.gwtbootstrap4.extras.typeahead.client.base.Template::render()();
                } : undefined),
                footer: (footerTemplate != null ? function (query) {
                    return footerTemplate.@org.gwtbootstrap4.extras.typeahead.client.base.Template::render()();
                } : undefined),
                suggestion: (suggestionTemplate != null ? function (suggestion) {
                    return suggestionTemplate.@org.gwtbootstrap4.extras.typeahead.client.base.SuggestionTemplate::render(Lorg/gwtbootstrap4/extras/typeahead/client/base/Suggestion;)(suggestion);
                } : undefined)
            }
    ...
    private native void configure(
        ...
        $wnd.jQuery(e).typeahead({
            ...
            .on('typeahead:opened', function (e) {
                that.@org.gwtbootstrap4.extras.typeahead.client.ui.Typeahead::onOpened(Lcom/google/gwt/user/client/Event;)(e);
            })
            .on('typeahead:closed', function (e) {
                that.@org.gwtbootstrap4.extras.typeahead.client.ui.Typeahead::onClosed(Lcom/google/gwt/user/client/Event;)(e);
            })
            .on('typeahead:cursorchanged', function (e, value, datasetName) {
                that.@org.gwtbootstrap4.extras.typeahead.client.ui.Typeahead::onCursorChanged(Lcom/google/gwt/user/client/Event;Lorg/gwtbootstrap4/extras/typeahead/client/base/Suggestion;)(e, value);
            })
            .on('typeahead:autocompleted', function (e, value, datasetName) {
                that.@org.gwtbootstrap4.extras.typeahead.client.ui.Typeahead::onAutoCompleted(Lcom/google/gwt/user/client/Event;Lorg/gwtbootstrap4/extras/typeahead/client/base/Suggestion;)(e, value);
            })
            .on('typeahead:selected', function (e, value, datasetName) {
                that.@org.gwtbootstrap4.extras.typeahead.client.ui.Typeahead::onSelected(Lcom/google/gwt/user/client/Event;Lorg/gwtbootstrap4/extras/typeahead/client/base/Suggestion;)(e, value);
            });
    }-*/;
