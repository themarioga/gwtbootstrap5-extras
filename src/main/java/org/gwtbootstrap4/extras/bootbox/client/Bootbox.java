...
import org.gwtbootstrap4.extras.bootbox.client.callback.ConfirmCallback;
import org.gwtbootstrap4.extras.bootbox.client.callback.PromptCallback;
import org.gwtbootstrap4.extras.bootbox.client.callback.SimpleCallback;
import org.gwtbootstrap4.extras.bootbox.client.options.AlertOptions;
import org.gwtbootstrap4.extras.bootbox.client.options.BootboxLocale;
import org.gwtbootstrap4.extras.bootbox.client.options.ConfirmOptions;
import org.gwtbootstrap4.extras.bootbox.client.options.DialogOptions;
import org.gwtbootstrap4.extras.bootbox.client.options.PromptOptions;
...
public class Bootbox {
    ...
    public static native void alert(String msg, SimpleCallback callback) /*-{
        $wnd.bootbox.alert(msg, function () {
            callback.@org.gwtbootstrap4.extras.bootbox.client.callback.SimpleCallback::callback()();
        });
    }-*/;
    ...
    public static native void confirm(String msg, ConfirmCallback callback) /*-{
        $wnd.bootbox.confirm(msg, function (result) {
            callback.@org.gwtbootstrap4.extras.bootbox.client.callback.ConfirmCallback::callback(Z)(result);
        });
    }-*/;
    ...
    public static native void prompt(String msg, PromptCallback callback) /*-{
        $wnd.bootbox.prompt(msg, function (result) {
            callback.@org.gwtbootstrap4.extras.bootbox.client.callback.PromptCallback::callback(Ljava/lang/String;)(result);
        });
    }-*/;
