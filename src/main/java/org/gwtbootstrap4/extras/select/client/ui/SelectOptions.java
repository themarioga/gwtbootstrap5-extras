    ...
    final native void setCountSelectedTextHandler(CountSelectedTextHandler handler) /*-{
        if (handler) {
            this.countSelectedText = function(selectedCount, totalCount) {
                handler.@org.gwtbootstrap4.extras.select.client.ui.CountSelectedTextHandler::getCountSelectedText(II)(selectedCount, totalCount);
            }
    ...
    final native void setMaxOptionsTextHandler(MaxOptionsTextHandler handler) /*-{
        if (handler) {
            this.maxOptionsText = function(numAll, numGroup) {
                return [
                    handler.@org.gwtbootstrap4.extras.select.client.ui.MaxOptionsTextHandler::getMaxSelectOptionsText(I)(numAll),
                    handler.@org.gwtbootstrap4.extras.select.client.ui.MaxOptionsTextHandler::getMaxGroupOptionsText(I)(numGroup)
                ];
            }
