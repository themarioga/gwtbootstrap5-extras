...
import org.gwtbootstrap4.extras.select.client.ui.constants.SelectStyles;
import org.gwtbootstrap4.extras.select.client.ui.constants.SelectWidth;
import org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers;
import org.gwtbootstrap4.extras.select.client.ui.event.HiddenEvent;
import org.gwtbootstrap4.extras.select.client.ui.event.HiddenHandler;
import org.gwtbootstrap4.extras.select.client.ui.event.HideEvent;
import org.gwtbootstrap4.extras.select.client.ui.event.HideHandler;
import org.gwtbootstrap4.extras.select.client.ui.event.LoadedEvent;
import org.gwtbootstrap4.extras.select.client.ui.event.LoadedHandler;
import org.gwtbootstrap4.extras.select.client.ui.event.RefreshedEvent;
import org.gwtbootstrap4.extras.select.client.ui.event.RefreshedHandler;
import org.gwtbootstrap4.extras.select.client.ui.event.RenderedEvent;
import org.gwtbootstrap4.extras.select.client.ui.event.RenderedHandler;
import org.gwtbootstrap4.extras.select.client.ui.event.ShowEvent;
import org.gwtbootstrap4.extras.select.client.ui.event.ShowHandler;
...
public abstract class SelectBase<T> extends ComplexWidget implements HasValue<T>, HasEnabled, Focusable,
    ...
    private native void bindSelectEvents(Element e) /*-{
        ...
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::SHOW_EVENT, function(event) {
            @org.gwtbootstrap4.extras.select.client.ui.event.ShowEvent::fire(Lorg/gwtbootstrap4/extras/select/client/ui/event/HasShowHandlers;)(select);
        });
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::SHOWN_EVENT, function(event) {
            @org.gwtbootstrap4.extras.select.client.ui.event.ShownEvent::fire(Lorg/gwtbootstrap4/extras/select/client/ui/event/HasShownHandlers;)(select);
        });
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::HIDE_EVENT, function(event) {
            @org.gwtbootstrap4.extras.select.client.ui.event.HideEvent::fire(Lorg/gwtbootstrap4/extras/select/client/ui/event/HasHideHandlers;)(select);
        });
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::HIDDEN_EVENT, function(event) {
            @org.gwtbootstrap4.extras.select.client.ui.event.HiddenEvent::fire(Lorg/gwtbootstrap4/extras/select/client/ui/event/HasHiddenHandlers;)(select);
        });
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::RENDERED_EVENT, function(event) {
            @org.gwtbootstrap4.extras.select.client.ui.event.RenderedEvent::fire(Lorg/gwtbootstrap4/extras/select/client/ui/event/HasRenderedHandlers;)(select);
        });
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::REFRESHED_EVENT, function(event) {
            @org.gwtbootstrap4.extras.select.client.ui.event.RefreshedEvent::fire(Lorg/gwtbootstrap4/extras/select/client/ui/event/HasRefreshedHandlers;)(select);
        });
    }-*/;
    ...
    private native void unbindSelectEvents(Element e) /*-{
        ...
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::CHANGED_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::SHOW_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::SHOWN_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::HIDE_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::HIDDEN_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::RENDERED_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.select.client.ui.event.HasAllSelectHandlers::REFRESHED_EVENT);
    }-*/;
