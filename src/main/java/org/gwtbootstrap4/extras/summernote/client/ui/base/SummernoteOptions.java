...
class SummernoteOptions extends JavaScriptObject {
    ...
    final native void setToolbar(Toolbar toolbar) /*-{
        this.toolbar = toolbar.@org.gwtbootstrap4.extras.summernote.client.ui.base.Toolbar::build()();
    }-*/;
    ...
    final native void setLanguage(SummernoteLanguage language) /*-{
        this.lang = language.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteLanguage::getCode()();
    }-*/;
    ...
    final native void setHint(String match, HintHandler searchHandler) /*-{
        this.hint = {
            ...
            search: function (keyword, callback) {
                var items = searchHandler.@org.gwtbootstrap4.extras.summernote.client.ui.base.HintHandler::onSearch(Ljava/lang/String;)(keyword);
                var result = [];
            ...
            template: function (item) {
                return searchHandler.@org.gwtbootstrap4.extras.summernote.client.ui.base.HintHandler::getTemplate(Ljava/lang/String;)(item);
            },
            content: function (item) {
                return searchHandler.@org.gwtbootstrap4.extras.summernote.client.ui.base.HintHandler::getContent(Ljava/lang/String;)(item);
            }
        };
    }-*/;
