package org.gwtbootstrap4.extras.summernote.client.ui.base;
...
import org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteBlurEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteBlurHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteChangeEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteChangeHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteEnterEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteEnterHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteFocusEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteFocusHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteImageUploadEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteImageUploadEvent.ImageFile;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteImageUploadHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteInitEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteInitHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteKeyDownEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteKeyDownHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteKeyUpEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernoteKeyUpHandler;
import org.gwtbootstrap4.extras.summernote.client.event.SummernotePasteEvent;
import org.gwtbootstrap4.extras.summernote.client.event.SummernotePasteHandler;
...
public class SummernoteBase extends Div implements HasAllSummernoteHandlers, HasEnabled {
    ...
    */
    ...
    private native void initialize(Element e, SummernoteOptions options) /*-{
        var target = this;
        options.callbacks = {};
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasInitHandler) {
            options.callbacks.onInit = function() {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteInitEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteInitHandlers;)(target);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasEnterHandler) {
            options.callbacks.onEnter = function () {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteEnterEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteEnterHandlers;)(target);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasFocusHandler) {
            options.callbacks.onFocus = function() {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteFocusEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteFocusHandlers;)(target);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasBlurHandler) {
            options.callbacks.onBlur = function() {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteBlurEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteBlurHandlers;)(target);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasKeyUpHandler) {
            options.callbacks.onKeyup = function(e) {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteKeyUpEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteKeyUpHandlers;Lcom/google/gwt/dom/client/NativeEvent;)(target, e.originalEvent);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasKeyDownHandler) {
            options.callbacks.onKeydown = function(e) {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteKeyDownEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteKeyDownHandlers;Lcom/google/gwt/dom/client/NativeEvent;)(target, e.originalEvent);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasUploadImageHandler) {
            options.callbacks.onImageUpload = function(files) {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteImageUploadEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteImageUploadHandlers;Lcom/google/gwt/core/client/JsArray;)(target, files);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasPasteHandler) {
            options.callbacks.onPaste = function() {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernotePasteEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernotePasteHandlers;)(target);
            };
        }
        if (this.@org.gwtbootstrap4.extras.summernote.client.ui.base.SummernoteBase::hasChangeHandler) {
            options.callbacks.onChange = function() {
                @org.gwtbootstrap4.extras.summernote.client.event.SummernoteChangeEvent::fire(Lorg/gwtbootstrap4/extras/summernote/client/event/HasSummernoteChangeHandlers;)(target);
            };
        }
    ...
    private native void destroy(Element e) /*-{
        ...
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_INIT_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_ENTER_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_FOCUS_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_BLUR_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_KEYUP_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_KEYDOWN_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_PASTE_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_IMAGE_UPLOAD_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.summernote.client.event.HasAllSummernoteHandlers::SUMMERNOTE_CHANGE_EVENT);
    }-*/;
