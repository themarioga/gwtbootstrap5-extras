package org.gwtbootstrap4.extras.toggleswitch.client.ui.base;
...
import org.gwtbootstrap4.extras.toggleswitch.client.ui.base.constants.ColorType;
import org.gwtbootstrap4.extras.toggleswitch.client.ui.base.constants.SizeType;
...
public class ToggleSwitchBase extends Widget implements HasSize<SizeType>, HasValue<Boolean>, HasValueChangeHandlers<Boolean>,
    ...
    private native void switchInit(Element e) /*-{
        ...
        $wnd.jQuery(e).on('switchChange.bootstrapSwitch', function (em, state) {
            me.@org.gwtbootstrap4.extras.toggleswitch.client.ui.base.ToggleSwitchBase::onChange(Z)(state);
        });
    }-*/;
