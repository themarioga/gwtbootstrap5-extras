...
public class TagsInputOptions<T> extends JavaScriptObject {
    ...
    public final native void setTagClass(final TagClassCallback<T> callback) /*-{
        this.tagClass = function(item) {
            return callback.@org.gwtbootstrap4.extras.tagsinput.client.callback.TagClassCallback::getTagClass(Ljava/lang/Object;)(item);
        }
    }-*/;
    ...
    public final native void setItemValue(final ItemValueCallback<T> callback) /*-{
        this.itemValue = function(item) {
            return callback.@org.gwtbootstrap4.extras.tagsinput.client.callback.ItemValueCallback::getItemValue(Ljava/lang/Object;)(item);
        }
    }-*/;
    ...
    public final native void setItemText(final ItemTextCallback<T> callback) /*-{
        this.itemText = function(item) {
            return callback.@org.gwtbootstrap4.extras.tagsinput.client.callback.ItemTextCallback::getItemText(Ljava/lang/Object;)(item);
        }
    }-*/;
    ...
    public final native void onTagExists(final OnTagExistsCallback<T> callback) /*-{
        this.onTagExists = function(item, tag) {
            callback.@org.gwtbootstrap4.extras.tagsinput.client.callback.OnTagExistsCallback::onTagExists(Ljava/lang/Object;Lcom/google/gwt/dom/client/Element;)(item, tag[0]);
        }
    }-*/;
}
