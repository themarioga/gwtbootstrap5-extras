package org.gwtbootstrap4.extras.tagsinput.client.ui.base;
...
import org.gwtbootstrap4.extras.tagsinput.client.callback.ItemTextCallback;
import org.gwtbootstrap4.extras.tagsinput.client.callback.ItemValueCallback;
import org.gwtbootstrap4.extras.tagsinput.client.callback.OnTagExistsCallback;
import org.gwtbootstrap4.extras.tagsinput.client.callback.TagClassCallback;
import org.gwtbootstrap4.extras.tagsinput.client.event.BeforeItemAddEvent;
import org.gwtbootstrap4.extras.tagsinput.client.event.BeforeItemAddHandler;
import org.gwtbootstrap4.extras.tagsinput.client.event.BeforeItemRemoveEvent;
import org.gwtbootstrap4.extras.tagsinput.client.event.BeforeItemRemoveHandler;
import org.gwtbootstrap4.extras.tagsinput.client.event.ItemAddedEvent;
import org.gwtbootstrap4.extras.tagsinput.client.event.ItemAddedHandler;
import org.gwtbootstrap4.extras.tagsinput.client.event.ItemAddedOnInitEvent;
import org.gwtbootstrap4.extras.tagsinput.client.event.ItemAddedOnInitHandler;
import org.gwtbootstrap4.extras.tagsinput.client.event.ItemRemovedEvent;
import org.gwtbootstrap4.extras.tagsinput.client.event.ItemRemovedHandler;
import org.gwtbootstrap4.extras.typeahead.client.base.Dataset;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadSelectedEvent;
import org.gwtbootstrap4.extras.typeahead.client.events.TypeaheadSelectedHandler;
import org.gwtbootstrap4.extras.typeahead.client.ui.Typeahead;
...
class TagsInputBase<T> extends Widget implements HasAllTagsInputEvents<T>, HasChangeHandlers {
    ...
    private native void initialize(Element e, JavaScriptObject options) /*-{
        ...
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::ITEM_ADDED_ON_INIT_EVENT, function(event) {
            @org.gwtbootstrap4.extras.tagsinput.client.event.ItemAddedOnInitEvent::fire(Lorg/gwtbootstrap4/extras/tagsinput/client/event/HasItemAddedOnInitHandlers;Ljava/lang/Object;)(tagsInput, event.item);
        });
        
        $wnd.jQuery(e).tagsinput(options);

        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::BEFORE_ITEM_ADD_EVENT, function(event) {
            @org.gwtbootstrap4.extras.tagsinput.client.event.BeforeItemAddEvent::fire(Lorg/gwtbootstrap4/extras/tagsinput/client/event/HasBeforeItemAddHandlers;Ljava/lang/Object;)(tagsInput, event.item);
        });

        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::ITEM_ADDED_EVENT, function(event) {
            @org.gwtbootstrap4.extras.tagsinput.client.event.ItemAddedEvent::fire(Lorg/gwtbootstrap4/extras/tagsinput/client/event/HasItemAddedHandlers;Ljava/lang/Object;)(tagsInput, event.item);
        });

        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::BEFORE_ITEM_REMOVE_EVENT, function(event) {
            @org.gwtbootstrap4.extras.tagsinput.client.event.BeforeItemRemoveEvent::fire(Lorg/gwtbootstrap4/extras/tagsinput/client/event/HasBeforeItemRemoveHandlers;Ljava/lang/Object;)(tagsInput, event.item);
        });

        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::ITEM_REMOVED_EVENT, function(event) {
            @org.gwtbootstrap4.extras.tagsinput.client.event.ItemRemovedEvent::fire(Lorg/gwtbootstrap4/extras/tagsinput/client/event/HasItemRemovedHandlers;Ljava/lang/Object;)(tagsInput, event.item);
        });
        ...
        ////////////////////
        $wnd.jQuery(e).on(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::ITEM_CHANGED_EVENT, function(event) {
            var currentValue = $wnd.jQuery(e).val();

            if ($wnd.jQuery.isArray(currentValue)) {
                @com.google.gwt.event.logical.shared.ValueChangeEvent::fire(Lcom/google/gwt/event/logical/shared/HasValueChangeHandlers;Ljava/lang/Object;)(tagsInput, @org.gwtbootstrap4.extras.tagsinput.client.ui.base.TagsInputBase::toMultiValue(Lcom/google/gwt/core/client/JavaScriptObject;)(currentValue));
            }
            else {
    ...
    private native void add(Element e, T tag) /*-{
        $wnd.jQuery(e).tagsinput(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.TagsInputCommand::ADD, tag);
    }-*/;
    
    private native void remove(Element e, T tag) /*-{
        $wnd.jQuery(e).tagsinput(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.TagsInputCommand::REMOVE, tag);
    }-*/;
    
    private native Element input(Element e) /*-{
        return $wnd.jQuery(e).tagsinput(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.TagsInputCommand::INPUT);
    }-*/;
    ...
    private native JsArray<JavaScriptObject> getItems(Element e) /*-{
        return $wnd.jQuery(e).tagsinput(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.TagsInputCommand::ITEMS);
    }-*/;
    
    private native void destroy(Element e) /*-{
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::ITEM_ADDED_ON_INIT_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::BEFORE_ITEM_ADD_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::ITEM_ADDED_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::BEFORE_ITEM_REMOVE_EVENT);
        $wnd.jQuery(e).off(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.HasAllTagsInputEvents::ITEM_REMOVED_EVENT);
                
        return $wnd.jQuery(e).tagsinput(@org.gwtbootstrap4.extras.tagsinput.client.ui.base.TagsInputCommand::DESTROY);
    }-*/;
}
